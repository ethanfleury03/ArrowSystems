...
class User(bases.BaseUser):
    ...
    saved: Optional[List['models.SavedResponse']] = None
    queries: Optional[List['models.QueryHistory']] = None
...
class QueryHistory(bases.BaseQueryHistory):
    """Represents a QueryHistory record"""

    id: _str
    user: Optional['models.User'] = None
    userId: _str
    queryText: _str
    answerText: Optional[_str] = None
    responseTimeMs: Optional[_int] = None
    metadata: Optional['fields.Json'] = None
    createdAt: datetime.datetime
    feedback: Optional[List['models.Feedback']] = None
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.QueryHistoryKeys']] = None,
        exclude: Optional[Iterable['types.QueryHistoryKeys']] = None,
        required: Optional[Iterable['types.QueryHistoryKeys']] = None,
        optional: Optional[Iterable['types.QueryHistoryKeys']] = None,
        relations: Optional[Mapping['types.QueryHistoryRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.QueryHistoryKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _QueryHistory_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _QueryHistory_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _QueryHistory_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if exclude_relational_fields:
                fields = {
                    key: data
                    for key, data in fields.items()
                    if key not in _QueryHistory_relational_fields
                }

            if relations:
                for field, type_ in relations.items():
                    if field not in _QueryHistory_relational_fields:
                        raise errors.UnknownRelationalFieldError('QueryHistory', field)
            ...
            raise ValueError(
                f'{exc.args[0]} is not a valid QueryHistory / {name} field.'
            ) from None
...
class Feedback(bases.BaseFeedback):
    ...
    user: Optional['models.User'] = None
    userId: _str
    query: Optional['models.QueryHistory'] = None
    queryId: _str
    isHelpful: _bool
    confidence: Optional[_float] = None
    intentType: Optional[_str] = None
    createdAt: datetime.datetime
...
class SavedResponse(bases.BaseSavedResponse):
    """Represents a SavedResponse record"""
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.SavedResponseKeys']] = None,
        exclude: Optional[Iterable['types.SavedResponseKeys']] = None,
        required: Optional[Iterable['types.SavedResponseKeys']] = None,
        optional: Optional[Iterable['types.SavedResponseKeys']] = None,
        relations: Optional[Mapping['types.SavedResponseRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.SavedResponseKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _SavedResponse_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _SavedResponse_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _SavedResponse_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if exclude_relational_fields:
                fields = {
                    key: data
                    for key, data in fields.items()
                    if key not in _SavedResponse_relational_fields
                }

            if relations:
                for field, type_ in relations.items():
                    if field not in _SavedResponse_relational_fields:
                        raise errors.UnknownRelationalFieldError('SavedResponse', field)
            ...
            raise ValueError(
                f'{exc.args[0]} is not a valid SavedResponse / {name} field.'
            ) from None
...
_User_fields: Dict['types.UserKeys', PartialModelField] = OrderedDict(
    [
        ...
        ('saved', {
            ...
            'is_list': True,
            'optional': True,
            'type': 'List[\'models.SavedResponse\']',
            'is_relational': True,
            'documentation': None,
        }),
        ('queries', {
...
_QueryHistory_relational_fields: Set[str] = {
        'user',
        'feedback',
    }
_QueryHistory_fields: Dict['types.QueryHistoryKeys', PartialModelField] = OrderedDict(
    [
        ('id', {
            'name': 'id',
            'is_list': False,
...
_SavedResponse_relational_fields: Set[str] = {
        'user',
    }
_SavedResponse_fields: Dict['types.SavedResponseKeys', PartialModelField] = OrderedDict(
    [
        ('id', {
            'name': 'id',
            'is_list': False,
...
model_rebuild(QueryHistory)
model_rebuild(Feedback)
model_rebuild(SavedResponse)
