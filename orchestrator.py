...
class DocumentEvaluator:
    ...
    def __init__(self, model_name: str = "claude-3-5-sonnet-latest", enable_caching: bool = True):
...
class ClaudeAnswerGenerator:
    ...
    def __init__(self, api_key: str = None, model_name: str = "claude-3-5-sonnet-latest", enable_caching: bool = True):
        self.model_name = model_name
        self.enable_caching = enable_caching
        self.answer_cache = {}
        self.claude_client = None
