...
class BaseQueryHistory(_PrismaModel):
    __prisma_model__: ClassVar[Literal['QueryHistory']] = 'QueryHistory'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.QueryHistoryActions[_PrismaModelT]':
        from .client import get_client

        return actions.QueryHistoryActions[_PrismaModelT](client or get_client(), cls)
...
class BaseSavedResponse(_PrismaModel):
    __prisma_model__: ClassVar[Literal['SavedResponse']] = 'SavedResponse'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.SavedResponseActions[_PrismaModelT]':
        from .client import get_client

        return actions.SavedResponseActions[_PrismaModelT](client or get_client(), cls)
